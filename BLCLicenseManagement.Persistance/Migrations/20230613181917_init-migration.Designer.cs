...
namespace BLCLicenseManagement.Persistence.Migrations
{
    ...
    [Migration("20230613181917_init-migration")]
            ...
            modelBuilder.Entity("BLCLicenseManagement.Domain.LicenseType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2023, 6, 13, 19, 19, 17, 258, DateTimeKind.Local).AddTicks(579),
                            DateModified = new DateTime(2023, 6, 13, 19, 19, 17, 258, DateTimeKind.Local).AddTicks(580),
                            Name = "Trial"
                        });
                });
            ...
            modelBuilder.Entity("BLCLicenseManagement.Domain.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2023, 6, 13, 19, 19, 17, 258, DateTimeKind.Local).AddTicks(770),
                            DateModified = new DateTime(2023, 6, 13, 19, 19, 17, 258, DateTimeKind.Local).AddTicks(771),
                            Email = "",
                            Name = "Admin",
                            Role = ""
                        });
