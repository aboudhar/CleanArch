...
namespace BLCLicenseManagement.Persistence.Migrations
{
    ...
    [Migration("20230615175500_addApplicationTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BLCApplicationInstanceOfLicense", b =>
                {
                    b.Property<int>("BLCApplicationsId")
                        .HasColumnType("int");

                    b.Property<int>("InstanceOfLicensesId")
                        .HasColumnType("int");

                    b.HasKey("BLCApplicationsId", "InstanceOfLicensesId");

                    b.HasIndex("InstanceOfLicensesId");

                    b.ToTable("BLCApplicationInstanceOfLicense");
                });
            ...
            modelBuilder.Entity("BLCLicenseManagement.Domain.LicenseType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2023, 6, 15, 18, 55, 0, 130, DateTimeKind.Local).AddTicks(3923),
                            DateModified = new DateTime(2023, 6, 15, 18, 55, 0, 130, DateTimeKind.Local).AddTicks(3923),
                            Name = "Trial"
                        });
                });
            ...
            modelBuilder.Entity("BLCLicenseManagement.Domain.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2023, 6, 15, 18, 55, 0, 130, DateTimeKind.Local).AddTicks(4175),
                            DateModified = new DateTime(2023, 6, 15, 18, 55, 0, 130, DateTimeKind.Local).AddTicks(4176),
                            Email = "",
                            Name = "Admin",
                            Role = ""
                        });
            ...
            modelBuilder.Entity("BLCApplicationInstanceOfLicense", b =>
                {
                    ...
                    b.HasOne("BLCLicenseManagement.Domain.InstanceOfLicense", null)
                        .WithMany()
                        .HasForeignKey("InstanceOfLicensesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
